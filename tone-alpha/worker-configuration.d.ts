/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4191235dc2f8667eea1655038f4e4f31)
// Runtime types generated with workerd@1.20251008.0 2025-08-29 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env {
		NEXT_PUBLIC_SITE_URL: "https://alpha.lab.tone.finance";
		NEXT_PUBLIC_PROJECT_NAME: string;
		NEXT_PUBLIC_ONCHAINKIT_API_KEY: string;
		FINDEX_GATEWAY_URL: string;
		FINDEX_CLIENT_ID: string;
		FINDEX_CLIENT_SECRET: string;
		ASSETS: Fetcher;
	}
}
